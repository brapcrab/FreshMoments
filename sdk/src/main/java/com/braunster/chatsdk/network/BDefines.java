...
public class BDefines {
    ...
    public static String ServerUrl = "https://freshmoments-e57b3.firebaseio.com//" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://freshmoments-e57b3.appspot.com";
